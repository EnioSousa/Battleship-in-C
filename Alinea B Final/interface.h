...
/* Imprime a informação de quantos barcos estão ativos para cada tipo de barco*/
...
/*Esperar durante alguns segundos */
void waitS(int i);

/*Imprime a pergunta se o player quer voltar jogar */
int askContinue();

/*Imprime a direcções possiveis*/
void directionHelpPrint();

/*Imprime o nome dos barcos activos*/
void printShipActive(Player* p);
